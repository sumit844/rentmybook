...
const Footer: React.FC = () => {
  return (
    <footer className="bg-gray-300 text-black font-bold py-12">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><span className="text-black">New Ashok Nagar</span></li>
              <li><span className="text-black">Pari Chawk</span></li>
              <li><span className="text-black">Rajendra Nager</span></li>
              <li><span className="text-black">Mukherji Nagar</span></li>
              <li><span className="text-black">Electronic City</span></li>
            </ul>
          </div>
